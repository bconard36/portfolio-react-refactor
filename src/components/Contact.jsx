...
import { sendTemplatedEmails } from "../utils/emailService";
import { contactNotification, contactAutoReply } from "../utils/emailTemplates";
        ...
        <div className="contact">
          <form id="contact-form" onSubmit={sendEmail} ref={form}>
            ...
            {referral === "Other" && (
              <div id="referral-container">
                <label htmlFor="other-referral-source" id="other">
                  Please specify how you found this website:
                </label>
                <textarea
          ...
          {success && (
            <p className="success-message">
              Message successfully sent. I'll be in touch!
            </p>
          )}
        </div>
      </section>
